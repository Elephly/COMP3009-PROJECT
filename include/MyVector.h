...
{
public:
	MyVector2D(MyVector3D const & vector);
	MyVector2D(MyVector4D const & vector);
...
{
public:
	MyVector3D(MyVector2D const & vector, float z = 0.0f);
	MyVector3D(MyVector4D const & vector);
	MyVector3D(float x = 0.0f, float y = 0.0f, float z = 0.0f);
	MyVector3D(MyColorRGBA const & color);
	~MyVector3D();
...
{
public:
	MyVector4D(MyVector2D const & vector, float z = 0.0f, float w = 1.0f);
	MyVector4D(MyVector3D const & vector, float w = 1.0f);
	MyVector4D(float x = 0.0f, float y = 0.0f, float z = 0.0f, float w = 1.0f);
	MyVector4D(MyColorRGBA const & color);
	~MyVector4D();
